...
_SEO_PAGES = {
    ("wellness", "why-diets-fail"): {
        "title": "Why Diets Fail — The Kingdom Answer to Lasting Health",
        "meta_description": "Discover why modern diets fail and what Scripture reveals about lasting health. Pastor Kahu Phil Stephens shares the Kingdom approach to wellness from Molokai, Hawaii.",
        "hero_image": "/static/images/ulu_kalo_mango.jpg",
        "body_md": (
            "## Why Diets Fail — And What Actually Works\n\n"
            "Every diet promises transformation. Most deliver temporary results followed by frustration.\n\n"
            "After 30 years of studying Scripture and a lifetime on the land of Molokaʻi, **Kahu Phil Stephens** discovered why.\n\n"
            "---\n\n"
            "### The Problem Is Not Your Willpower\n\n"
            "Modern diets attack symptoms. They count calories, eliminate food groups, and build a relationship of war between you and your own body.\n\n"
            "But the body God designed does not operate on war. It operates on **covenant** — a deep, rooted alignment between how you eat and how you were made to live.\n\n"
            "When you fight your body, you lose. When you align with how God designed it, something different happens.\n\n"
            "---\n\n"
            "### What the Kingdom Reveals About Food\n\n"
            "The Kingdom of God is not abstract theology. It touches every dimension of life — including the way you eat.\n\n"
            "In Scripture, food is not a discipline problem. It is a **stewardship** problem. The question is not \"how little can I eat?\" but \"how faithfully am I stewarding the temple God gave me?\"\n\n"
            "The ancestral Hawaiian diet — built on taro, breadfruit, fish, and seasonal eating — was not a diet plan. It was a **covenant with the land**. People ate what the land gave, in the rhythm the land set. The result was a population of extraordinary health and strength for thousands of years.\n\n"
            "That rhythm did not fail. We abandoned it. And our bodies are paying the price.\n\n"
            "---\n\n"
            "### The Three Reasons Diets Fail\n\n"
            "**1. They treat the symptom, not the root.**\n"
            "Weight is not the problem. Disconnection from God's design is the problem. Until you address the root, every diet is temporary.\n\n"
            "**2. They rely on willpower, not wisdom.**\n"
            "Willpower is a finite resource. Kingdom health is built on revelation — on *seeing* your body through the lens of Scripture — and revelation sustains what willpower cannot.\n\n"
            "**3. They ignore how you eat, not just what you eat.**\n"
            "The *way* you eat matters as much as the food itself. Rushed, distracted, anxious eating — even of good food — undermines your body's ability to receive nourishment. The Kingdom approach changes everything about the *experience* of eating.\n\n"
            "---\n\n"
            "### A Different Starting Point\n\n"
            "Kahu Phil lost 54 pounds not by going on a diet — but by returning to Kingdom principles of eating rooted in Scripture and the ancestral wisdom of his land.\n\n"
            "The **Aloha Wellness** book documents that journey and the practical framework behind it.\n\n"
            "---\n\n"
