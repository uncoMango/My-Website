...
_SEO_PAGES = {
    ("wellness", "why-diets-fail"): {
        ...
        "meta_description": "Most diets fail because they work against how the human body is designed. Learn why dieting breaks down over time and what sustainable, ancestral, and biblical principles reveal about lasting health.",
        ...
        "body_md": (
            ...
            "Most people assume diets fail because of a lack of discipline or motivation.\n\n"
            "But after decades of observation and lived experience, the deeper issue is simpler:\n\n"
            "Diets are structurally unsustainable for most people.\n\n"
            "They rely on restriction, rigid rules, and short-term effort instead of long-term alignment with how the body naturally functions.\n\n"
            "---\n\n"
            "### The Cycle That Repeats\n\n"
            "Most diets follow the same pattern:\n\n"
            "- Strict rules\n"
            ...
            "This cycle repeats not because people are weak, but because the system itself does not match human behavior or biology.\n\n"
            "---\n\n"
            "### What Ancient Eating Patterns Show Us\n\n"
            "Across many Indigenous and ancestral cultures, including Hawaiian and Polynesian traditions, eating was not structured around constant restriction or rigid schedules.\n\n"
            "Food patterns were:\n\n"
            "- Responsive to daily life\n"
            "- Connected to physical labor and land\n"
            "- Less focused on constant intake\n"
            "- More aligned with natural rhythms\n\n"
            "The modern idea of strict, scheduled eating is historically recent, not universal.\n\n"
            "---\n\n"
            "### A Different Biblical Perspective\n\n"
            "Scripture does not present the body as something to dominate through restriction, but something to steward with wisdom.\n\n"
            "Stewardship implies:\n\n"
            "- Awareness\n"
            "- Balance\n"
            "- Restraint when needed\n"
            "- Freedom from excess systems of control\n\n"
            "This is not about diet rules. It is about alignment.\n\n"
            "---\n\n"
            "### Why Diets Eventually Break Down\n\n"
            "Diets fail long-term because:\n\n"
            "- They rely on external control instead of internal awareness\n"
            "- They ignore emotional and cultural eating patterns\n"
            "- They are not designed for lifelong sustainability\n"
            "- They create stress around something that should be natural\n\n"
            "Eventually, the pressure outweighs compliance.\n\n"
            "---\n\n"
            "### What Actually Works Long-Term\n\n"
            "Sustainable health is not built on restriction.\n\n"
            "It is built on:\n\n"
            "- Consistent but flexible habits\n"
            "- Awareness of hunger and fullness\n"
            "- Reducing metabolic stress\n"
            "- Aligning eating with lifestyle and environment\n\n"
            "This is not a program.\n\n"
            "It is a return to functional living.\n\n"
            "---\n\n"
            "### The Aloha Wellness Approach\n\n"
            "Aloha Wellness is built on a different foundation:\n\n"
            "- Scripture-based perspective on stewardship\n"
            "- Hawaiian cultural wisdom from lived experience on the land\n"
            "- Practical, sustainable habits instead of rigid systems\n\n"
            "It is not a diet.\n\n"
            "It is a reset in how you relate to food, body, and discipline.\n\n"
            "---\n\n"
            "If you are tired of cycles that do not last, begin with a simpler approach.\n\n"
            "[**Free Aloha Wellness Guide →**](/download/aloha_wellness_freebie)\n\n"
            "[**Aloha Wellness Book →**](/aloha_wellness)\n\n"
            "A sustainable path begins with understanding, not restriction.\n\n"
            "---\n\n"
