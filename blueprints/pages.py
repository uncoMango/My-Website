...
_SEO_PAGES = {
    ...
    ("training-001", "why-do-i-keep-starting-over"): {
        "title": "Why Do I Keep Starting Over? | Free Rotten Fencepost™ Training",
        "meta_description": "A free, self-guided training for anyone who keeps beginning again — health, habits, routines, projects, or money. Map one real restart cycle, separate the visible failure from what may be underneath it, and choose one practical seven-day action. No account required.",
        "hero_image": "/static/rf_photo_library/sources/rf_phil_horse_ukulele_beach.jpg",
        "hero_fit": "contain",
        "body_md": (
            "## The Rotten Fencepost™ Training 001 — Free Beginning\n\n"
            "### Why Do I Keep Starting Over?\n\n"
            "*Find what keeps undoing your progress.*\n\n"
            "By [Kahu Phil Stephens](/author) — Rotten Fencepost Publishing\n\n"
            "You may not need another plan. You may need to find out what keeps undoing the plans "
            "you already make. If you keep beginning again — health, habits, routines, "
            "projects, money, or another recurring part of life — this free training will "
            "help you inspect one real pattern before you start over again.\n\n"
            "---\n\n"
            "## Start Here\n\n"
            "Choose one recurring problem. Not your whole life. One place where you repeatedly "
            "start, stop, repair, abandon, or promise to change.\n\n"
            "There are no grades and nothing to submit. This training belongs to you. Read it "
            "with a notebook nearby (or use the printable guide below) to observe one real "
            "pattern and take one useful action.\n\n"
            "---\n\n"
            "## Session 1 — Why Do I Keep Starting Over?\n\n"
            "You may already know what you are supposed to do. You may have made plans, started "
            "routines, tried harder, and begun again more times than you care to count. The "
            "question for this training is not, “How do I try harder this time?” It is, "
            "“Why do I keep having to start over in the first place?”\n\n"
            "A repeated failure is not only discouraging. It is information. If the same place "
            "keeps failing, something may be happening before the part that gets your "
            "attention.\n\n"
            "**Map one restart.** Write down, in your own words:\n\n"
            "- The thing I keep starting over with\n"
            "- Why I decided to change\n"
            "- What I intended to do\n"
            "- How things went at first\n"
            "- The first noticeable disruption\n"
            "- The point where I decided I had failed\n"
            "- What I did after that\n\n"
            "Do not judge the map yet. Gather evidence first.\n\n"
            "---\n\n"
            "## Session 2 — The Part That Fell May Not Be the Part That Failed\n\n"
            "When a fence leans, the visible problem demands attention. The wire may be loose. A "
            "staple may have pulled. Tightening the wire may make the fence look right again. But "
            "if the post is rotten below the ground, tightening the wire cannot make the post "
            "sound.\n\n"
            "**The Rotten Fencepost™ Principle: never confuse what failed with why it failed.**\n\n"
            "The missed workout, purchase, argument, abandoned project, food choice, or broken "
            "routine may matter. But if the same visible problem keeps returning, ask what it is "
            "attached to.\n\n"
            "**Symptom or cause?** Ask yourself:\n\n"
            "- What is the visible problem — the part that gets my attention?\n"
            "- What do I normally try to repair?\n"
            "- If I fixed that visible problem today, what would keep it from coming back?\n"
            "- Maybe the part I keep repairing is not the whole problem — why?\n\n"
            "---\n\n"
            "## Session 3 — What Happened Before This Happened?\n\n"
            "Most problem-solving begins after the failure is already visible. Instead, walk "
            "backward. Ask, “What happened before this?” Then ask again. Look for a "
            "pressure, condition, expectation, environment, routine, neglected responsibility, or "
            "repeated sequence that appears before the collapse.\n\n"
            "**Backward trace.** Starting from the moment you normally call the failure, ask:\n\n"
            "- What happened immediately before that?\n"
            "- And before that?\n"
            "- What conditions were present?\n"
            "- What keeps weakening the same place?\n\n"
            "---\n\n"
            "## Your First Fence Inspection\n\n"
            "Bring together what you've found: the recurring problem, the symptom you normally "
            "notice, what you normally repair, what seems to happen before it returns, and the "
            "pressure or condition that deserves closer inspection.\n\n"
            "### Seven-Day Action\n\n"
            "Do not rebuild everything yet. For the next seven days, choose one thing you will do "
            "differently, and decide what you will watch for.\n\n"
            "**You have completed the free beginning.** Keep what you learned and use it whether "
            "or not you continue.\n\n"
            "---\n\n"
            "## If You Choose to Continue\n\n"
            "The complete training walks with you from inspection into rebuilding: test the "
            "suspected weak point, decide whether to repair, replace, reinforce, or maintain, "
            "build a Wind Plan for the days pressure comes, recover from setbacks without "
            "automatically starting from zero, and keep a reusable Fence Inspection Record you "
            "can use again on any recurring problem.\n\n"
            "The complete Training 001 is currently being finalized for release. "
            "[Explore the Rotten Fencepost Principle →](/rotten-fencepost) in the meantime, "
            "or read more about [Kahu Phil Stephens →](/author).\n\n"
            "---\n\n"
            "### A Note on What This Is\n\n"
            "- Self-guided. No live coaching required.\n"
            "- No grades or submitted homework.\n"
            "- Designed for practical reflection and action.\n"
            "- Does not diagnose or replace medical, mental-health, financial, legal, or other "
            "professional care.\n\n"
            "[**Download the printable Free Guide (PDF) →**](/media/training_001_free_guide_pdf_v1)\n\n"
            "---\n\n"
            "### Going Deeper\n\n"
            "This training builds on the same Rotten Fencepost™ teaching as "
            "[Why Do I Keep Starting Over?](/campaign/002), "
            "[Find the Cause, Not the Symptoms](/rotten-fencepost/find-the-cause-not-the-symptoms), "
            "and [The Storm Did Not Rot the Post — It Revealed It](/rotten-fencepost/the-storm-did-not-rot-the-post). "
            "For the full teaching library, visit the [Rotten Fencepost hub →](/rotten-fencepost)."
        ),
    },
}
