...
<script src="https://www.paypal.com/sdk/js?client-id=PAYPAL_CLIENT_ID_PLACEHOLDER&currency=USD"></script>
<script>
paypal.Buttons({
    ...
    onCancel: function(data) {
        window.location.href = '/aloha_wellness';
    },
    onError: function(err) {
        alert('Payment error. Please try again or email kahuphil@keaupuni.faith');
    }
...
.download-btn { display: inline-block; padding: 1.25rem 2.5rem; background: #28a745; color: white; text-decoration: none; border-radius: 8px; font-size: 1.2rem; font-weight: bold; margin-bottom: 1.5rem; }
...
To receive your ebook, please email: <strong>kahuphil@keaupuni.faith</strong><br>
Subject: <em>Aloha Wellness Download</em><br><br>
Kahu Phil will send your download within 24 hours. Aloha!
</div>
<p style="font-size:0.9rem; color:#6c757d;">
We are working to make downloads fully automatic.<br>
Until then, your email is the fastest path to your book.
</p>
...
<body>
    ...
    <script>
        paypal.Buttons({{
            ...
            onError: function(err) {{
                alert('Payment error. Please try again or contact kahuphil@keaupuni.faith');
            }}
        }}).render('#paypal-button-container');
    </script>
</body>
