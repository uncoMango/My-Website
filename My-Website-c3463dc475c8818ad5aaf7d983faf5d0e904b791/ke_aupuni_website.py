...
# --- THE MANDATE: SEO & NAVIGATION ---
# I added your vision keywords here for Google to find you
...
:root {
    ...
    --accent-teal: #5f9ea0;
    --accent-warm: #d4a574;
    --white-70: rgba(255, 255, 255, 0.7); /* THIS FIXES YOUR TRANSPARENCY */
}
...
.nav-title { font-size: 1.6rem; font-weight: bold; color: var(--accent-teal); text-decoration: none; }
...
.content-card { 
    background: var(--white-70) !important; /* 70% TRANSPARENCY - LAUHALA IS VISIBLE */
    padding: 3rem; 
    border-radius: 20px; 
    ...
    if DATA_FILE.exists():
        try:
            with open(DATA_FILE, "r", encoding="utf-8") as f:
                data = json.load(f)
                # Ensure the Myron Golden page exists in your JSON
