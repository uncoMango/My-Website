...
DEFAULT_PAGES = {
    ...
    "pages": {
        ...
        "the_mandate": {
            ...
            "hero_image": "https://i.imgur.com/wmHEyDo.png",
            "body_md": "## The Mandate\r\n\r\nContent for the 20-Volume series goes here. You can now edit this in your Admin panel!",
            "product_url": ""
        },
        "kingdom_wealth": {
            "title": "Kingdom Wealth & Stewardship",
            "hero_image": "https://i.imgur.com/wmHEyDo.png",
            "body_md": "## Kingdom Wealth\r\n\r\n### Funding the Mission\r\n\r\nContent for Kingdom Wealth goes here. You can now edit this in your Admin panel!",
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="products_json" name="products_json" style="min-height: 180px;">{products_json}</textarea>
