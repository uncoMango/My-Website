...
DEFAULT_PAGES = {
    ...
    "pages": {
        ...
        # Rotten Fencepost Foreman YouTube API compliance audit: the one
        # public page Google's Audit and Quota Extension Form requires
        # (Privacy Policy URL, evidence screenshots) before the Foreman's
        # already-proven upload pipeline can publish public (not just
        # private) videos. Copy approved verbatim by Kahu Phil after two
        # rounds of review against YouTube API Services Developer Policies
        # -- see the Discovery Engine's own PROJECT_LOG.md, 2026-08-10, and
        # WORKFORCE/Departments/Publishing/Employees/Long_Form_Video_Publishing_Agent/evidence/YOUTUBE_COMPLIANCE_AUDIT_PACKAGE.md
        # for the full review trail. Reuses the same page.html/DEFAULT_PAGES
        # pattern as every other content page; no new template or route.
        "privacy-policy": {
            "title": "Privacy Policy — YouTube Publishing Integration",
            "hero_image": "/static/images/molokai_coast.jpg",
            "seo_title": "Privacy Policy — YouTube Publishing Integration | Ke Aupuni O Ke Akua",
            "meta_description": "How the Rotten Fencepost Foreman uses YouTube API Services to publish Kahu Phil Stephens' own teaching videos, including scope, data handling, and how to revoke access.",
            "body_md": "## Privacy Policy — YouTube Publishing Integration\r\n\r\nThis page describes how the Rotten Fencepost Foreman, an internal publishing tool operated by Kahu Phil Stephens for keaupuniakeakua.faith, uses YouTube API Services.\r\n\r\n### What this integration does\r\n\r\nThe Foreman uses the YouTube Data API (YouTube API Services) to upload Kahu Phil's own long-form teaching videos to his own YouTube channel. It is authorized with a single Google account — Kahu Phil's own — and is not a public service that other people sign into or use.\r\n\r\n### What it accesses and stores\r\n\r\n- The Foreman's OAuth authorization is stored locally, on infrastructure Kahu Phil controls, and is never exposed publicly.\r\n- When publishing an already-approved video, the Foreman sends that video's file and its approved metadata (title, description, and related publishing details) to YouTube.\r\n- It records the YouTube video ID and publication status YouTube returns, so the campaign's own publishing records stay accurate.\r\n- It does not access, collect, or store YouTube data belonging to any other channel or person.\r\n\r\n### Scope requested\r\n\r\nThe Foreman currently requests only the `youtube.upload` scope. It cannot read, list, edit, or delete any existing video, comment, playlist, or channel data, and is never used for any purpose beyond publishing this site's own approved content.\r\n\r\n### Revoking access\r\n\r\nKahu Phil can revoke the Foreman's Google/YouTube authorization at any time through Google's account permissions page:\r\n\r\n[https://myaccount.google.com/permissions](https://myaccount.google.com/permissions)\r\n\r\nRevoking authorization prevents the Foreman from making further authorized YouTube API calls on his behalf. The Foreman handles locally stored authorization credentials and YouTube API Data in accordance with the YouTube API Services Developer Policies, including applicable requirements concerning storage, refresh, and deletion.\r\n\r\nRevoking authorization does not itself delete videos or other information already stored by YouTube; those remain governed by YouTube and the Google account that owns the channel.\r\n\r\n### Google's Privacy Policy\r\n\r\nGoogle's own Privacy Policy, describing how Google itself handles data, is available at:\r\n\r\n[https://policies.google.com/privacy](https://policies.google.com/privacy)\r\n\r\n### YouTube Terms of Service\r\n\r\nUse of the Rotten Fencepost Foreman's YouTube publishing integration is subject to YouTube's Terms of Service, available at:\r\n\r\n[https://www.youtube.com/t/terms](https://www.youtube.com/t/terms)\r\n\r\n### Contact\r\n\r\nQuestions about this policy:\r\n\r\n[kahuphil@keaupuni.faith](mailto:kahuphil@keaupuni.faith)",
        },
    },
}
...
HUB_FEATURED_CAMPAIGN_IDS = ["001", "002", "003"]
